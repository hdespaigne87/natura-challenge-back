package com.natura.challenge.back.algorithms.highest_repeating_word.rest_controller;

import com.natura.challenge.back.algorithms.highest_repeating_word.dto.HighestRepeatingWordResult;
import com.natura.challenge.back.algorithms.highest_repeating_word.service.HighestRepeatingWordService;
...
public class HighestRepeatingWordRestController {
    ...
    @PostMapping
    public ResponseEntity<?> smallestLargestNumber(@RequestParam("file") MultipartFile file) {
